...
After I got something I was happy with, I wanted to make it super easy to deploy my blog. I created a post commit hook so every time I commit my blog to github it publish my blog.

Adding the following lines of code to .git/hooks/post-commit and making the file executable will do the trick!
