...
Ciphers can be tricky to work with. Even tricker if you're trying to get two seperate system's ciphers to work together. Ruby gives you an extra hurtle to get over by setting it's IV (initialization vector) to "OpenSSL for Ruby rulez!" by default.
...
So word to the wise: Always make sure you're setting your IV when using encryption in Ruby!
